...
import { setMessages, resetUnreadMessage } from "../redux/messageSlice";
...
function MessageArea() {
  ...
  useEffect(() => {
    if (selectedUser) {
      getAllMessages();
      dispatch(resetUnreadMessage(selectedUser._id));
    }
  }, [selectedUser]);
  ...
  return (
    <div className="w-full h-[100vh] bg-black relative">
      <div className="w-full flex items-center gap-[15px] px-[20px] py-[10px] fixed to-0 z-[100] bg-black">
